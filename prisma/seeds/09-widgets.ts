...
export async function seedWidgets(prisma: PrismaClient) {
    ...
    const quotesData = [
        ...
        { name: '시온', content: "코레 어려워야~?" },
        { name: '시온', content: "모~자가 어딨노~♪ 내 모자 어딨노~♪" },
        ...
        { name: '유우시', content: "인생은 3점" },

        { name: '재희', content: "을사을사 화이팅" },
        { name: '재희', content: "복지피스-" },
        { name: '재희', content: "그니까" },
        { name: '재희', content: "오하수💚" },
        { name: '재희', content: "이게 우예 댄기고" },
        { name: '재희', content: "대영 한국산입니다" },
        { name: '재희', content: "쪽덕쪽덕 얼굴에 착붙지?" },
        { name: '재희', content: "아 쌔그러버라!" },
        { name: '재희', content: "정말 많고 많은 사람들 중에 나를 좋아해주서 고마워" },
        { name: '재희', content: "이 세상 끝까지 사랑합니댕🌳💚" },
